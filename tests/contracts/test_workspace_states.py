...
class WorkspaceStateContractTests(unittest.TestCase):
    ...
    WORKSPACES = {
        ...
        "application builder": (
            ...
            "products/resume_taylor/static/app-shell.js",
        ),
        "interview preparation": (
            "products/resume_taylor/templates/application_builder/base.html",
            "products/resume_taylor/templates/application_builder/interview_preparation.html",
            "products/resume_taylor/static/app-shell.js",
            "products/resume_taylor/static/interview-preparation.js",
        ),
    }
    ...
    RETRY_CONTROLS = {
        ...
        "application builder": ("application-builder-error-retry", "products/resume_taylor/static/app-shell.js"),
    }
