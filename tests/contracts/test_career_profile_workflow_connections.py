...
MOCK_SOURCE = MOCK_INTERVIEW_SOURCE
...
class CareerProfileWorkflowConnectionTests(unittest.TestCase):
    ...
    def test_all_five_workflows_use_the_shared_adapter(self) -> None:
        ...
        worker_source = (ROOT / "job_discovery" / "background_worker.py").read_text(encoding="utf-8")
        self.assertIn('career_profile_context=dict(payload.get("career_profile_context") or {})', worker_source)
