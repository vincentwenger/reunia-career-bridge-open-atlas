    ...
    def test_education_update_preserves_record_position(self) -> None:
        ...
        changed = apply_baseline_education(
            ...
            0,
            {
                ...
                "institution": "Redwood Institute Continuing Studies",
                "location": "Berkeley, CA",
                "date": "2024",
        ...
        self.assertEqual(profile.education[0].institution, "Redwood Institute Continuing Studies")
...
class BaselineSummaryEducationInterfaceContracts(unittest.TestCase):
    ...
    def test_javascript_saves_with_csrf_and_refreshes_updated_baseline(self) -> None:
        javascript = (
            ROOT
            / "products"
            / "resume_taylor"
        ...
        self.assertIn("refreshSections", javascript)
