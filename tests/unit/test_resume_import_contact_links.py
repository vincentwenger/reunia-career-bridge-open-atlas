...
def _empty_profile() -> CandidateProfile:
    return CandidateProfile(
        name="Alex Morgan",
        contact=ContactInfo(location="Portland, OR", phone="", email="alex.morgan@example.com"),
...
class ResumeImportContactLinkTests(unittest.TestCase):
    def test_word_header_hyperlinks_are_included_in_extracted_text(self) -> None:
        ...
        header.add_run("Alex Morgan | ")
        _add_hyperlink(
            header,
            "LinkedIn",
            "https://www.linkedin.com/in/career-bridge-demo-candidate/",
        )
        header.add_run(" | ")
        _add_hyperlink(
            header,
            "GitHub",
            "https://github.com/career-bridge-demo-candidate",
        )
        ...
        self.assertIn("https://www.linkedin.com/in/career-bridge-demo-candidate/", extracted)
        self.assertIn("https://github.com/career-bridge-demo-candidate", extracted)

    def test_professional_urls_are_classified_from_resume_text(self) -> None:
        urls = professional_contact_urls(
            "LinkedIn: linkedin.com/in/career-bridge-demo-candidate GitHub: www.github.com/career-bridge-demo-candidate"
        )

        self.assertEqual(
            urls["linkedin_url"],
            "https://linkedin.com/in/career-bridge-demo-candidate",
        )
        self.assertEqual(
            urls["github_url"],
            "https://www.github.com/career-bridge-demo-candidate",
        )
    ...
    def test_missing_structured_urls_are_restored_without_overwriting_existing_values(self) -> None:
        ...
        restored = restore_professional_contact_urls(
            profile,
            "LinkedIn https://linkedin.com/in/replacement GitHub https://github.com/career-bridge-demo-candidate",
        )
