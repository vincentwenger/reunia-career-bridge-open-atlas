...
AI Configuration, catalog management, Admin Analytics, and incidents are server-protected. Normal candidate accounts do not receive model identifiers or configuration controls.
