...
from .resume_language import (
    RESUME_TRANSLATION_FIELDS_SYSTEM,
    ResumeTranslationFields,
    build_resume_translation_fields_prompt,
...
class ResumeAI:
    ...
    def translate_candidate_profile(
        ...
        *,
        ...
        try:
            translated = merge_resume_translation_fields(profile, translated_fields)
        except ValueError as exc:
            raise ResumeAIError(str(exc)) from exc
